...
result.TM1_1(result.phase==phase1.powerlevel) = result.CM_el(result.phase==phase1.powerlevel) * input.plant.partialload.phase1.powerlevel * input.plant.peakpower_el;
result.TM1_1(result.phase==phase2.powerlevel) = result.CM_el(result.phase==phase2.powerlevel) * input.plant.partialload.phase2.powerlevel * input.plant.peakpower_el;
result.TM1_1(result.phase==phase3.powerlevel) = result.CM_el(result.phase==phase3.powerlevel) * input.plant.partialload.phase3.powerlevel * input.plant.peakpower_el;
